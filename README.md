...
- [139. Word Break](https://leetcode.com/problems/word-break/)：经典题，recursion + memorization，还有DP
...
- [137. Single Number II](https://leetcode.com/problems/single-number-ii/)：Counting set
...
- [212. Word Search II](https://leetcode.com/problems/word-search-ii/)：DFS解法：O(sum(mn*4^l)).也就是上题直接包一层循环。  Trie解法：O(mn*4^l)
